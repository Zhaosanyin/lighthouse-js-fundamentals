...
//=== ??? why 
// it is very important that if, else if, else structures in the js.
...
console.log(runner + " received a " + model + " medal.");
...
其他不同类型之间的比较均不相等.
————————————————
版权声明：本文为CSDN博主「wang171838」的原创文章，遵循CC 4.0 BY-SA版权协议，转载请附上原文出处链接及本声明。
原文链接：https://blog.csdn.net/wang171838/article/details/8554305
*/